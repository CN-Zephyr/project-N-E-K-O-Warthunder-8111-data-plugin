...
- 逻辑自检以 `uv run python tests/run_logic_tests.py` 的 `209/209 passed` 为准。
...
- 不要沿用旧的 pre-T-Safety / pre-free-text-gate / pre-identity / pre-T-Output / pre-T-Kill-Coalesce / pre-L8 / pre-L9-takeoff-grace / pre-output-coalescing / pre-event-expiry / pre-T-UI2 / pre-deferred-hud-notice / pre-radio-altitude / pre-V2-proximity / pre-rc-docs-audit / pre-tailing-risk 测试数量；当前逻辑自检应以 `209/209 passed` 为准。
